var quiz = [
    ...
    {
        question: 'Wo findet jährlich der weltgrößte Karneval statt?',
        info: 'Rio de Janeiro, Brasilien',
        solution: {lat: -22.903539, lng: -43.209587}
    },
    {
        question: 'Wo befindet sich die höchste Achterbahn der Welt?',
        info: 'Kingda Ka, Six Flags Great Adventure, Jackson, New Jersey, Vereinigte Staaten',
        solution: {lat: 40.139165, lng: -74.43665}
    },
    {
        question: 'Wo hat Samsung seinen Hauptsitz?',
        info: 'Seoul, Südkorea',
        solution: {lat: 37.488472, lng: 127.054028}
    },
    {
        question: 'Wo wurde Che Guevara hingerichtet?',
        info: 'La Higuera, Bolivien',
        solution: {lat: -18.794765, lng: -64.201434}
    },
    {
        question: 'Wo hat der Internationale Gerichtshof seinen Sitz?',
        info: 'Den Haag, Niederlande',
        solution: {lat: 52.086637, lng: 4.295815}
    },
    {
        question: 'Wo wurde der Vertrag unterschrieben, der die UdSSR auflöste?',
        info: 'Almaty (Alma-Ata), Kasachstan',
        solution: {lat: 43.255058, lng: 76.912628}
    },
    {
        question: 'Wo residiert der Dalai Lama?',
        info: 'Lhasa, Tibet, China',
        solution: {lat: 29.645554, lng: 91.140856}
    },
    {
        question: 'Wo explodierte im April 1986 ein Atomkraftwerk?',
        info: 'Chernobyl, Ukraine',
        solution: {lat: 51.389444, lng: 30.099167}
    },
    {
        question: 'Wo wurde Franz Kafka geboren?',
        info: 'Prag, Tschechien (Österreich-Ungarn)',
        solution: {lat: 50.075538, lng: 14.437801}
    }
];
